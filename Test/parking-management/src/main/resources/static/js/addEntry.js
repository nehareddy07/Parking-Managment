...
function add(){
	 ...
	 let from = getInput($("#from"), true);
	 let to = getInput($("#to"), true);
	 let code = getInput($("#code"), true);

	    $.ajax({
	        type: "POST",
	        contentType: "application/json",
	        url: "entry",
	        data: JSON.stringify({ area: area,parkingName: parkingName, price:price, count: count, fromDate: from, toDate: to, code: code}),
	        success: () => {
